...
class SubscriptionsFeedRepositoryImplTest {
    ...
    fun setUp() {
        ...
        repository =
            SubscriptionsFeedRepositoryImpl(
    ...
    @Test
    fun `getSubscriptionPosts should emit Success state initially`() =
        runTest {
    ...
    @Test
    fun `getSubscriptionPosts should emit Empty state when sourceIds are empty`() =
        runTest {
    ...
    @Test
    fun `getSubscriptionPosts should emit Error state when an exception occurs`() =
        runTest {
