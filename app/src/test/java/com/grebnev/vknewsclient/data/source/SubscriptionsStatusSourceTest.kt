...
class SubscriptionsStatusSourceTest {
    ...
    fun setUp() {
        ...
        subscriptionsStatusSource = SubscriptionsStatusSource(
            mockApiService,
            mockMapper,
            mockAccessToken
        )
    ...
    @Test
    fun `getSubscriptionsState should emit initial state`() = runTest {
    ...
    @Test
    fun `getSubscriptionsState should emit updated state after changeSubscriptionStatus`() = runTest {
        val mockSubscription = Subscription(
            id = 1L,
            title = "SubscriptionsVkNews",
            sourceIds = setOf(-123, 456)
    ...
    @Test
    fun `changeSubscriptionStatus should remove subscription if sourceIds are empty`() = runTest {
        val mockSubscription = Subscription(
            id = 1L,
            title = "SubscriptionsVkNews",
            sourceIds = setOf(789)
