...
class ProfileInfoRepositoryImplTest {
    ...
    @Test
    fun `getProfileInfo should emit Loading initially`() = runTest {
    ...
    @Test
    fun `getProfileInfo should emit Success state when apiService returns valid response`() = runTest {
    ...
    @Test
    fun `getProfileInfo should emit Error when API call fails`() = runTest {
